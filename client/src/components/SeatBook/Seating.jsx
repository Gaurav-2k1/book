  ...
  return (
    <div>
        ...
        <div className="UpperBaar">
            ...
            <div><img src={"vectorLeft.png"}></img></div>
            <div><p>Eternals</p>
            ...
            <div >2 Tickets</div>
            <div><img src={"vectorUpper.png"}/></div>
            </div>
            <div><img src ={"vectorCross.png"}/></div>
            </div>
        </div>
      ...
      <div className="imageScreen"><img src={"screen.png"}/>
        ...
        <div className="availabilityImage">
         ...
         <div className="soldSeats"><img src={"sold.png"} /><div>Sold</div></div>
         
         <div className="soldSeats"><img src={"available.png"}/><div>Available</div></div>
         <div className="soldSeats"><img src={"selected.png"}/><div>Selected</div></div>
         </div>
         </div>
    </div>
  );
